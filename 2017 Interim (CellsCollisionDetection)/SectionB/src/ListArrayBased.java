public class ListArrayBased<T> implements ListInterface<T> {
   ...
   */
  public synchronized T get(int givenPosition) throws ListIndexOutOfBoundsException {
   ...
   */
  public synchronized void add(int givenPosition, T newItem)
   ...
   * @throws an exception if position is less than 1 or greater that the size of the list
   */
  public synchronized void remove(int givenPosition) throws ListIndexOutOfBoundsException {
    if (givenPosition >= 1 && givenPosition <= length) {
